...
public class CaregiverService {
    ...
    public void updateCaregiverProfile(String username, CaregiverProfileUpdateRequest caregiverProfileUpdateRequest) {
        Member currentMember = getMember(username);
        getCaregiver(currentMember).updateDetailProfile(caregiverProfileUpdateRequest.getAddress(), caregiverProfileUpdateRequest.getRating(),
                caregiverProfileUpdateRequest.getExperienceYears(), caregiverProfileUpdateRequest.getSpecialization(), caregiverProfileUpdateRequest.getCaregiverSignificant());
    }
