...
public class PatientSearchService {
    ...
    @Cacheable(value = "caregiverProfiles", key = "'caregiver_search_views' + #condition + '_' + #pageable.pageNumber", unless = "#result == null", cacheManager = "cacheManager")
    ...
    @Cacheable(value = "caregiverProfiles", key = "'caregiver_search_default' + #condition + '_' + #pageable.pageNumber", unless = "#result == null", cacheManager = "cacheManager")
