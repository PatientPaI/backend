...
@Component
public class ViewCountBasedRecommendStrategy implements RecommendStrategy {
    ...
    public List<CaregiverProfileResponse> recommendCaregivers(String username) {
        List<Caregiver> caregivers = caregiverRepository.findTop5ByViewCountsDesc();
    ...
    public List<PatientProfileResponse> recommendPatients(String username) {
        List<Patient> patients = patientRepository.findTop5ByViewCountsDesc();
